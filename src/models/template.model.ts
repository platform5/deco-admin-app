...
export class TemplateModel extends Model {
  ...
  @type.select({options: ['validate-email', 'double-auth', 'reset-password-code', 'change-email-or-mobile-code', 'shop/order-confirm', 'shop/order-paid', 'shop/order-payment', 'shop/supply-order-confirm', 'shop/packaging-return-reminder']})
  @validate.required
