...
{
key: `{ test: /\.ts$/, loader: "ts-loader" },`,
value: `{ test: /\.ts$/, loader: "ts-loader", include: [srcDir] },`
},
{
key: `xxx{loader: "app-settings-loader", options: {env: production ? 'production' : 'development' }},`,
